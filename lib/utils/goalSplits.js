...
// ponytail: self-check — run: node -e "import('./lib/utils/goalSplits.js').then(m=>{const s=m.buildMemberSplits(['a','b'],[70,30],1000000);console.assert(s[0].targetAmount===700000&&s[1].targetAmount===300000)})"
