...
export default function SignInPage() {
  ...
  if (isNative) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950 p-6">
        <motion.div
        ...
        >
          ...
          {!loading && (
            <Button
              ...
              className="w-full h-14 text-base font-medium gradient-bg-blue text-white border-0 hover:opacity-90 shadow-lg transition-all hover:shadow-xl hover:scale-[1.02]"
            >
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950 p-4 relative overflow-hidden">
      {/* Animated background blobs */}
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-primary-100 dark:bg-primary-900/20 rounded-full blur-3xl animate-blob mix-blend-multiply dark:mix-blend-normal filter opacity-40 dark:opacity-30"></div>
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-accent-100 dark:bg-accent-900/20 rounded-full blur-3xl animate-blob animation-delay-2000 mix-blend-multiply dark:mix-blend-normal filter opacity-40 dark:opacity-30"></div>
      ...
      <motion.div
        ...
        className="hidden lg:flex flex-col items-center justify-center w-full lg:w-1/2 h-full p-8 text-gray-900 dark:text-white text-center relative z-10"
      >
        <div className="max-w-md space-y-8">
          <Logo />
          <h1 className="text-4xl font-extrabold leading-tight">
            Take Control of Your <span className="gradient-text-blue-teal">Financial Future</span>
          </h1>
            ...
            {[
              ...
              return (
                <motion.div key={index} variants={itemVariants} className="flex items-center gap-3">
                  ...
                  <span className="text-base text-gray-700 dark:text-gray-100">{feature.text}</span>
                </motion.div>
              )
            })}
          </motion.div>
      ...
      >
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-2xl p-6 sm:p-8 space-y-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome to Mintmind</h2>
          ...
          {!loading && (
            <Button
              onClick={handleGoogleSignInClick}
              className="w-full h-12 text-base font-medium gradient-bg-blue text-white border-0 hover:opacity-90 shadow-lg transition-all hover:shadow-xl hover:scale-[1.02]"
            >
              <div className="flex items-center justify-center gap-3">
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
